class AssetsManger {
  ...
  static const String bagImagesPath = 'assets/images/bag';
  static const String bannersImagesPath = 'assets/images/banners';
  static const String categoriesImagesPath = 'assets/images/categories';
  static const String profileImagesPath = 'assets/images/profile';

  // general images
  static String forgotPassword = "$imagesPath/forgot_password.jpg";
  static String google = "$imagesPath/google_image.jpg";
